...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('orders')->insert(array(
            ...
            array('id' => '6','created_at' => '2021-03-04 10:00:15','updated_at' => NULL,'deleted_at' => NULL,'title' => 'test order by PM','branch_id' => '3','customer_id' => '6','has_delivery' => '0','total' => '200','commission_value' => '10','status' => 'completed','note' => 'test node','reciever_phone' => '0790909090','contents' => '{"contents": [{"item_1": {"count": "2", "price": "100", "item_id": "6"}}]}')
        ));
