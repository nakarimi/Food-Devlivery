                ...
                <div class="modal-body pt-0">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile-widget">
                                ...
                                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="#" id="customerName">Mike Litorus</a></h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="{{ route('blockCustomer') }}" id="block_form" accept-charset="UTF-8" style="display:inline">
                                {{ csrf_field() }}
