            ...
            @elseif(Auth::user()->role->name == "finance_manager")
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a  @if (\Request::is('restaurant.active_payments')) class="active" @endif href="{{ route('restaurantPendingPayments') }}">Active payments</a></li>
                            <li><a  @if (\Request::is('restaurantPaymentHistory')) class="active" @endif href="{{ route('restaurantPaymentHistory') }}">History of Payments</a></li>
                        </ul>
                    </li>
                </ul>
            @endif
