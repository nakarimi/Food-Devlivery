                        ...
                        <div class="table-responsive">
                            <table class="table table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $branch->user_id }} </td></tr><tr><th> Business Type </th><td> {{ $branch->business_type }} </td></tr><tr><th> Main Commission Id </th><td> {{ $branch->main_commission_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
