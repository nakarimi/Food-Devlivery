                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>User Id</th><th>Business Type</th><th>Main Commission Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($branch as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->user_id }}</td><td>{{ $item->business_type }}</td><td>{{ $item->main_commission_id }}</td>
                                        <td>
