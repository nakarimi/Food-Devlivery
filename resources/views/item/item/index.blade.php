                        ...
                        <tr>
                           ...
                           <td>
                            <h2 class="table-avatar">
                                    <a href="{{ url('/item/' . $singleItem->id) }}" class="avatar" style="width: 100px; height: 100px; background-color: transparent;"><img alt="" src="{{ url('storage/profile_images/' . $itemDetails->thumbnail) }}"></a>
                                </h2>
                            </td>
